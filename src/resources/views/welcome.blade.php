...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/back_principal.css') }}">
</head>
<body>
    <header>
        <div>
    ...
    <main>
        <div>
            <h2>CATÁLOGO</h2>
            <p>EXPLORAR TODAS LAS POSIBILIDADES</p>
        </div>
        <article>
            <section>
                <a href="#">
